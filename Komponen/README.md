...
Poin penting: <br>
• Menghemat 6–8 pin menjadi hanya 2 pin. <br>
• Rangkaian lebih rapi dan kecil kemungkinan salah sambung. <br>
• Bisa berbagi jalur dengan perangkat I2C lain selama alamat berbeda. <br>
---
...
Sensor api digunakan untuk mendeteksi keberadaan nyala api secara langsung melalui cahaya inframerah yang dipancarkan oleh api. Pada proyek ini, sensor api berfungsi sebagai lapisan keamanan tambahan selain sensor asap dan sensor suhu. Ketika sensor mendeteksi api, sistem akan langsung mengaktifkan alarm dan menampilkan status bahaya pada LCD.

Poin penting: <br>
• Mendeteksi keberadaan nyala api secara langsung. <br>
• Menggunakan sensor inframerah (IR). <br>
• Memberikan respon cepat terhadap potensi kebakaran. <br>
• Bekerja bersamaan dengan sensor asap dan sensor suhu untuk meningkatkan akurasi deteksi bahaya. <br>
---
...
ESP32 digunakan sebagai modul komunikasi Internet of Things (IoT) pada sistem. ESP32 menerima data dari Arduino Uno R4 melalui komunikasi serial, kemudian mengirimkan data tersebut ke platform Blynk melalui jaringan WiFi. Dengan adanya ESP32, kondisi laboratorium dapat dipantau secara real-time melalui smartphone tanpa harus berada di dekat perangkat.

Poin penting: <br>
• Menyediakan koneksi WiFi ke internet. <br>
• Menerima data sensor dari Arduino Uno R4 melalui UART (Serial). <br>
• Mengirim data ke aplikasi Blynk secara real-time. <br>
• Memungkinkan monitoring dan pengendalian sistem dari jarak jauh. <br>
